...
var TODO, debug, dev, error, fs, normalize, promise, ref, ref1, reporters, sep, sequence, shared, stacks, tester;

ref = require('path'), normalize = ref.normalize, sep = ref.sep;

ref1 = objective.logger, TODO = ref1.TODO, error = ref1.error;
