...
Default.prototype = Reporter.prototype;
Default.prototype.constructor = Default;
var Super = {
  beforeEach: Reporter.prototype.beforeEach,
  afterEach: Reporter.prototype.afterEach
};


Default.prototype.beforeEach = function(args, next) {
  Super.beforeEach.call(this, args, function(){});
...
Default.prototype.afterEach = function(args, next) {
  Super.afterEach.call(this, args, function(){});
  ...
  if (testNode.error) {
    console.log(this.currentIndent + (counts.fail + ') ' + this.currentTitle).red);
  }
