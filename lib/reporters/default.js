...
var EOL, TODO, accum, colors, debug, enabled, error, firstfail, fs, info, initialised, logger, pipe, showAssertionError, showCode, walkStack;
...
module.exports.enable = function() {
  ...
  pipe.on('multiple.done', function(data) {
