...
// TODO: help coffee with array of list for push multiple expectations on same function
    ...
    if (typeof list == 'object') {
      ...
      for (var funcName in list) {
        ...
        (function(funcName){
          ...
          //     throw new ConfigurationError('Cannot change expectation type for function \''+funcName+'\'',{
          //       thisAt: dev.runStep.step.info
          //     });
          //   }
          // } else {
