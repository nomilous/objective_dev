...
var TODO, config, debug, entities, error, info, injector, logger, original, pipeline, shortid,
  slice = [].slice;
...
pipeline = objective.pipeline, logger = objective.logger;

error = logger.error, info = logger.info, TODO = logger.TODO;
...
module.exports.create = function(object) {
  var i, len, name, pendingContexts, ref;
  try {
  ...
  ref = ['does', 'Does', 'spy', 'Spy', 'stub', 'Stub'];
  for (i = 0, len = ref.length; i < len; i++) {
    name = ref[i];
    if ((object[name] != null) && !object[name].toString().match(/MOCKER_FUNCTION/)) {
  ...
  Object.defineProperty(object, 'Spy', {
    ...
    get: function() {
      return function() {
        ...
        return object.Does.apply(null, args);
      };
    }
  });
  Object.defineProperty(object, 'spy', {
  ...
  Object.defineProperty(object, 'Stub', {
    configurable: true,
    enumerable: false,
    get: function() {
      return function() {
  ...
  Object.defineProperty(object, 'Does', {
    configurable: true,
    enumerable: false,
    get: function() {
      return function() {
  ...
  Object.defineProperty(object, 'does', {
    ...
    get: function() {
      return function() {
        var args, e, fn1, functions, j, len1, onClass, testType;
        ...
        for (j = 0, len1 = args.length; j < len1; j++) {
          ...
          fn1 = function(name) {
            ...
            stub = function() {
              ...
              /* EXPECTATION_STUB */
              var call, context, expected, ref1, result;
              expected = false;
              try {
                ref1 = entities[object.$$id].expectations[name][onClass].shift(), type = ref1.type, fn = ref1.fn, context = ref1.context;
                if (type === 'spy' || type === 'stub') {
        ...
        return {
          as: function(context) {
            var expectation, k, len2, results;
            results = [];
            for (k = 0, len2 = pendingContexts.length; k < len2; k++) {
              expectation = pendingContexts[k];
