          ...
          steps.map(function(step) {
            return function() {
              return promise(function(resolve, reject, notify) {
                ...
                if (testNode.pend || testNode.skip || testNode.cancelled) return resolve();
...
module.exports.getLastNotSkippedOrPending = function(nodes) {
  var node;
  for (var i = nodes.length; i > 0; ) {
    node = nodes[--i];
    if (!node.skip && !node.pend) break;
  }
  return node;
}
...
module.exports.runStep = function(root, config, testContext, step, resolve, reject) {
  ...
  process.nextTick(function() {
    if (!done && !currentStep.waiting) {
                      //
                     // undefined! how?
                    // eg: https://github.com/nomilous/ntree/commit/2aeb3c34c386eb57ec776ad9042ee117f782f185  
